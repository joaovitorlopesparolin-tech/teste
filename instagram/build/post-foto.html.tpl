...
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  body { background:#F2EAE1; color:#2E2823;
  ...
  .wrap img { position:absolute; inset:0; width:100%; height:100%;
    ...
    filter:saturate(.90) contrast(1.02) brightness(1.04); }

  .scrim { position:absolute; inset:0;
    background:linear-gradient(to bottom,
      rgba(242,234,225,.30) 0%,
      rgba(242,234,225,0) 18%,
      rgba(242,234,225,0) 32%,
      rgba(242,234,225,.62) 47%,
      rgba(242,234,225,.93) 57%,
      rgba(242,234,225,.995) 65%,
      #F2EAE1 71%); }
  ...
  .tag { position:absolute; top:46px; left:58px; background:rgba(242,234,225,.90); padding:14px 32px; border-radius:999px;
    font-size:19px; letter-spacing:.34em; text-transform:uppercase;
    color:#3A322B; white-space:nowrap; }

  .block { margin-top:auto; display:flex; flex-direction:column;
    align-items:center; }
  ...
  .sub { margin-top:22px; max-width:700px; font-weight:300;
    font-size:26px; line-height:1.5; color:#6A5C51; }

  .cta { margin-top:34px; border:1px solid #2E2823; border-radius:999px;
