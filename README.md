...
| **Trabalho simultâneo** | Com um servidor único (rede local ou Tailscale), as telas de todos se **atualizam sozinhas** quando alguém altera algo — sem recarregar, e sem interromper quem está digitando |
