...
echo Removendo a regra do firewall (se existir)...
powershell -NoProfile -Command "Start-Process cmd -ArgumentList '/c netsh advfirewall firewall delete rule name=\"Sistema Jaques Motorsport\"' -Verb RunAs" 2>nul
